...
$(function () {
  ...
  if (selectCompany.length) {
    var $this = selectCompany;
    $this.wrap('<div class="position-relative"></div>').select2({
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $.get(`${baseUrl}user-list\/${user_id}\/edit`, function (data) {
      ...
      $('#add-user-company').val(data.company.id).change();
      $('#add-user-country').val(data.country);
      $('#add-user-role').val(data.role.id);
    });
  });
