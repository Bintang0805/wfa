...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalSaveForm" tabindex="-1" aria-labelledby="modalSaveFormLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                  ...
                  @csrf
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-input mb-3">
                        ...
                        <input type="hidden" name="workflow_id" id="workflow_id" class="form-control" value="{{ $workflow->id }}">
                        <input type="text" disabled name="workflow_name" id="workflow_name" class="form-control" value="{{ $workflow->name }}">
                      ...
                      <div class="form-input mb-3">
                        ...
                        <input id="form-name" class="form-control" name="name" placeholder="Give a Name for this form" />
                      </div>
                      <div class="form-input">
                        <label for="form-description">Form Description</label>
                        <input id="form-description" class="form-control" name="description" placeholder="Give a Description for this form" />
                      </div>
                      <div class="preview-input-json w-100" id="preview-input-json" style="max-height: 40vh; overflow-x: auto">
