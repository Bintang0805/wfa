                ...
                <tbody>
                    @foreach ($workflows as $workflow)
                        <tr>
                            ...
                            <td>{{ $workflow->name }}</td>
                            <td class="d-flex">
                                <button class="send-request-button btn-sm btn btn-primary" data-id="{{ $workflow->associated_form }}"
    ...
    <div class="card mt-4">
        ...
        <div class="card-datatable table-responsive">
            <table id="datatables-workflows" class="datatables-workflows table border-top">
                ...
                <tbody>
                    @foreach ($request_workflows as $request_workflow)
                        <tr>
                            <td>{{ $request_workflow->id }}</td>
                            <td>{{ $request_workflow->workflow->name }}</td>
                            <td>
